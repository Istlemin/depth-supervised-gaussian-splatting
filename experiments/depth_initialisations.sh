...
$cmd --model_path output/table_images3_depth0_rand --initialisation=depth --lambda_depth=0
$cmd --model_path output/table_images3_depth0.8_rand --initialisation=depth --lambda_depth=0.8
